...
describe("Gallery Page", function () {
    it("renders the theme selection menu", function () {
        render(React.createElement(Gallery, null));
    ...
    it("switches between themes when a theme button is clicked", function () { return __awaiter(void 0, void 0, void 0, function () {
        var findByText, diaryButton, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    findByText = render(React.createElement(Gallery, null)).findByText;
                    return [4 /*yield*/, findByText(/Diary/i)];
                case 1:
                    diaryButton = _b.sent();
    ...
    it("renders the Custom List", function () {
        render(React.createElement(Gallery, null));
