  ...
  >
    ...
    >
      ...
      <Typography variant="body1" sx={{ mb: 2 }}>
        ...
        communities goes back much further. I grew up immersed in platforms like
        LiveJournal, GaiaOnline, Blogger, WordPress, and of course, MySpace. As
        a teenager and young adult, these sites offered a refuge from my chaotic
        home life. They gave me space to express myself freely, connect with
        other creatives, and build meaningful online communities rooted in
        shared passions and creative exchange.
      </Typography>
      <Typography variant="body1" sx={{ mb: 2 }}>
        ...
        creativity, rather than the polished performances we see on Instagram or
        TikTok.
      </Typography>
      <Typography variant="body1" sx={{ mb: 2 }}>
        The idea for SoulPad came after I shared a collection of photos from a
        hike at San Diego’s Torrey Pines on Instagram. I was frustrated—not only
        by the limited controls the platform offered, but also by how
        constrained I felt in presenting my perspective. I wanted to showcase my
        photos in a way that reflected my creativity, but the platform’s format
        didn’t allow it. That frustration became inspiration.
      </Typography>
      <Typography variant="body1" sx={{ mb: 2 }}>
        ...
        sci-fi cafe theme, or even a mini-game to play with connections. SoulPad
        is a space built for creative freedom, individuality, and authentic
        self-expression.
      </Typography>
      <Typography variant="body1" sx={{ mb: 2 }}>
        ...
        together we can build the kind of online world we’ve been missing:
        authentic, empowering, and truly our own.
      </Typography>
    </Box>
  </Paper>
);
